...
class PuzzleUI:
    def __init__(self, root):
        ...
        self.algo = ttk.Combobox(self.left, values=['BFS', 'DFS', 'IDFS', 'Greedy', 'A*', 'UCS', 'Simple Hill Climbing', 'Steepest Ascent Hill Climbing'], state='readonly', width=17, font=self.font_entry)
        self.algo.set('BFS')
